...
import coverImage from '@/assets/cover-projects.jpg';
...
const ProjectsSection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to(coverParts[0], { xPercent: -120 }, 0.4)
tl.to(coverParts[2], { xPercent: 120 }, 0.4)
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 md:px-8">
          ...
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-4xl md:text-6xl font-bold mb-4">
              <span className="text-gradient-primary">Selected</span>{' '}
                  ...
                  {index === 1 && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center text-white">
                        <h3 className="text-3xl md:text-5xl font-bold mb-4 drop-shadow-lg">Featured Projects</h3>
                        <p className="text-lg md:text-xl opacity-90 drop-shadow-md">Scroll to explore</p>
                      </div>
                    </div>
                  )}
                </div>
